...
class ProfilAdminEditGambar extends StatefulWidget {
  final ProfilModel model;
  final VoidCallback reload;
  const ProfilAdminEditGambar(this.model, this.reload, {super.key});

  @override
  State<ProfilAdminEditGambar> createState() => _ProfilAdminEditGambarState();
}

class _ProfilAdminEditGambarState extends State<ProfilAdminEditGambar> {
  late String userid;
